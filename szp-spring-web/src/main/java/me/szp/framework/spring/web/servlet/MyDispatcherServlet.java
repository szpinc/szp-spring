...
import me.szp.framework.spring.core.beans.InitBean;
import me.szp.framework.spring.web.mvc.Binding;
import me.szp.framework.spring.web.mvc.Handler;
import me.szp.framework.spring.web.mvc.ModelAndView;
import me.szp.framework.spring.web.mvc.ViewResolver;
...
import static me.szp.framework.spring.web.mvc.BindingRequestAndModel.bindingRequestAndModel;
        ...
        for (Map.Entry<String, Method> entry :
            ...
            if (url.equals(entry.getKey())) {
                ...
                if ("MyModelAndView".equals(returnType.getSimpleName())){
                    ...
                    ModelAndView myModelAndView = (ModelAndView) method.invoke(object, resultParameters.toArray());
