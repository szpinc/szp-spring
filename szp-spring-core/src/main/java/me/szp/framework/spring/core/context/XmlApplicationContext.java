...
import me.szp.framework.spring.core.beans.ChildBeanDefinition;
import me.szp.framework.spring.core.beans.GenericBeanDefinition;
import me.szp.framework.spring.core.constant.Constants;
import me.szp.framework.spring.core.exception.XmlException;
import me.szp.framework.spring.core.rules.IocRules;
import me.szp.framework.spring.core.utils.ScanUtils;
...
public class XmlApplicationContext {
     ...
     * @return
     */
    public List<String> resolveComponentList(String packageName) throws XmlException {

        if (StringUtils.isEmpty(packageName)) {
            throw new XmlException("请正确设置" + IocRules.SNAN_RULE.getType() + "的属性");
        }
        List<String> componentList = new ArrayList<>();
        List<String> componentListAfter = ScanUtils.getComponentList(packageName);
    ...
    private void setChildBeanDefinitionByType(Element element, ChildBeanDefinition childBeanDefinition, String name, String value,
                                              List<ChildBeanDefinition> childBeanDefinitionList) throws XmlException {
