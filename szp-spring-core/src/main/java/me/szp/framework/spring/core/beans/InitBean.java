...
import me.szp.framework.spring.core.context.ApplicationContext;
import me.szp.framework.spring.core.jdbc.SqlSession;
    ...
    public void initClass(String className) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
       ...
       //如果类是接口，注入的对象是动态代理的对象
        if (aClass.isInterface()){
            SqlSession mySqlSession = new SqlSession();
