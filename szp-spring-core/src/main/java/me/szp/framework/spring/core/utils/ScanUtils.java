package me.szp.framework.spring.core.utils;

import lombok.extern.slf4j.Slf4j;
import me.szp.framework.spring.common.utils.AnnotationUtils;
import me.szp.framework.spring.common.utils.CollectionsUtils;
import me.szp.framework.spring.core.annotation.Autowired;
import me.szp.framework.spring.core.annotation.Controller;
import me.szp.framework.spring.core.annotation.Repository;
import me.szp.framework.spring.core.annotation.Service;
...
public class ScanUtils {
    ...
    public static void resolveComponent(String className) throws ClassNotFoundException {
        ...
        addNewAnnotation(Controller.class, aClass);
        addNewAnnotation(Service.class, aClass);
        addNewAnnotation(Repository.class, aClass);
    }
    ...
    public static <A extends Annotation> void addNewAnnotation(Class<A> annotationClass, Class<?> aClass) throws ClassNotFoundException {
        ...
        if (!AnnotationUtils.isEmpty(aClass.getAnnotation(annotationClass))) {
            ...
            if (fields == null || fields.length == 0) {
                CollectionsUtils.addUnique(componentList, aClass.getName());
            } else {
